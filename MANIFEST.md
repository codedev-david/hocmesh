...
This archive is a source repository for **MESH Compute v0.3.0**.
...
- `docs/MESH_AI.md` — implemented AI architecture, commands, and runtime boundaries.
...
- `docs/ROADMAP.md` — implementation path to MESH AI.
